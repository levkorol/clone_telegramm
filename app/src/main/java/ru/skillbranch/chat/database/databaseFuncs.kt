package ru.skillbranch.chat.database
...
import ru.skillbranch.chat.utilits.AppValueEventListener
import ru.skillbranch.chat.utilits.showToast
...
fun initFirebase() {
    ...
    USER =
        UserModel()
    CURRENT_UID = AUTH.currentUser?.uid.toString() //id
...
fun sendMessage(message: String, receivingUserId: String, typeText: String, function: () -> Unit) {
    ...
    val refDialogReceivengUser = "$NODE_MESSAGES/$receivingUserId/$CURRENT_UID"
    ...
    mapDialogs["$refDialogReceivengUser/$messageKey"] = mapMessage
...
fun setNameToDatabase(fullname: String) {
    //добавляем в ноду юсер по айди поле полное имя
    REF_DATABASE_ROOT.child(
        NODE_USERS
...
fun uploadFileToStorage(uri: Uri, messageKey: String, recivedID: String, typeMessage: String) {
